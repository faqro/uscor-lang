...
| string_substr  | Variable Name, Variable Name or Data Value, Variable Name or Data Value  | Data Value  | Return a substring of param0 between positions param1 and param2  |
| string_find  | Variable Name, Variable Name or Data Value  | Data Value  | Return the index of the first occurrence of param1 in param0  |
